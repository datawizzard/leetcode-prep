...
# of arr[] with sum equal to given sum1
...
def isSubsetSum(arr, n, sum1):
	...
	# here we are using "OR" because if we found the required
	# subset at any point either from selecting or excluding
	# the element we have to return true;
